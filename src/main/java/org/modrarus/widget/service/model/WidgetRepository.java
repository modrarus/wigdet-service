...
public interface WidgetRepository {
	...
	/**
	 * Удаление виджета
	 * @param _widget Удаляемый виджет
	 * @return Флаг успешного удаления, если виджет не зарегистрирован в репозитории возвращается false
	 */
	public boolean delete(Widget _widget);
